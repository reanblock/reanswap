...
# --match-contract=${c}
test :; forge test -vv --match-test=${m}

test-fork :; forge test -vv --fork-url http://localhost:8545 --match-test=${m}

test-fork-all :; forge test -vv --fork-url http://localhost:8545
...
anvil-mainnet :; anvil --fork-url ${MAINNET_RPC_URL}

hardhat-mainnet :; npx hardhat node --fork ${MAINNET_RPC_URL}

chisel-fork :; chisel --fork-url http://localhost:8545
