...
contract ReanswapV2Pair is ERC20, Math {
    ...
    function swap(
        ...
        // check there is enough in reserve to satisfy the trade
        ...
        // preform a constant product check x * y = k
        // new balance product must be >= to the product of current reserves
